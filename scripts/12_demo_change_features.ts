...
async function main() {
  ...
  tx = await host.setFeatures(0,[['HEAD_SLOT',remoteHead.address,2],['FACE_SLOT',remoteFace.address,0],['BADGE1_SLOT',remoteBadge.address,4],['BADGE2_SLOT',remoteBadge.address,0]]);
  await tx.wait();
