...
contract NFT_721E is ERC721Enumerable, Ownable {
  /// ------------------------------------------------------------------------
  ...
  /// Variables
  /// ------------------------------------------------------------------------
  string public constant nftName = "NFT_721E";
  string public constant nftSymbol = "NFT_721E";
  string public constant nftDescription = "Generic ERC721Enumerable NFT";
